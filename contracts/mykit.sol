...
contract GeneScienceInterface {
    ...
    function mixGenes(uint256 genes1, uint256 genes2, uint256 targetBlock) public view returns (uint256);

    function genesToTokens(uint256 genes) public view returns (uint256[]);
}
...
contract KittyOwnership is KittyBase, ERC721 {
    ...
    string public constant name = "DreamKittens"; // Change to DreamKittens.
